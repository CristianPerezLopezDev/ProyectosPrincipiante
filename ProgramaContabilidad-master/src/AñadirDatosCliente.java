 ...
 * @author petot
 */
public class AñadirDatosCliente extends javax.swing.JDialog {

    /**
     * Creates new form DatosFactura
     */
    public AñadirDatosCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(!(txtNombre.getText().isEmpty()&&txtNombreEmpresa.getText().isEmpty()&&txtCorreo1.getText().isEmpty()&&txtCif.getText().isEmpty())){
            ...
            cP.lanzarSentencia("insert into cliente values ('"+nombre.toUpperCase()+"','"+cif+"','"+correo+"','"+nombreEmpresa.toUpperCase()+"')");
            JOptionPane.showMessageDialog(rootPane,"Registrado");
        }else{
            JOptionPane.showMessageDialog(rootPane,"Rellena todos los campos cago en to");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirDatosCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AñadirDatosCliente dialog = new AñadirDatosCliente(new javax.swing.JFrame(), true);
